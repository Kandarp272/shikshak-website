      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          <GlassCard className="p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-xl font-serif font-bold text-text-primary mb-4">1. Alpha Product Disclaimer</h2>
            ...
            <section>
              <h2 className="text-xl font-serif font-bold text-text-primary mb-4">2. Pilot Program Participation</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-serif font-bold text-text-primary mb-4">3. Data Usage</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-serif font-bold text-text-primary mb-4">4. Intellectual Property</h2>
              <p className="text-text-secondary leading-relaxed">
