      ...
      <div className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-3xl mx-auto">
          ...
          <GlassCard className="p-8 md:p-12 space-y-8">
            <section>
              <h2 className="text-xl font-syne font-bold text-text-primary mb-4">Our Commitment</h2>
            ...
            <section>
              <h2 className="text-xl font-syne font-bold text-text-primary mb-4">Data Collection</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-syne font-bold text-text-primary mb-4">Facial Attendance Data</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-syne font-bold text-text-primary mb-4">Third-Party Services</h2>
              <p className="text-text-secondary leading-relaxed">
